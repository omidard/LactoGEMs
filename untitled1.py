...
# -*- coding: utf-8 -*-
"""
Created on Tue May 17 14:01:08 2022
...
growth=[]
gapfilled_models = glob('%s/*.json'%'/Users/omidard/Desktop/lacba/Rhamnosus/gapfilled')
for gm in gapfilled_models:
    gmol = cobra.io.load_json_model(gm)
    m9(gmol)
    growth.append(gmol.optimize().fluxes.BIOMASS)