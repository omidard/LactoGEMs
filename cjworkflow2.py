...
# -*- coding: utf-8 -*-
"""
Created on Sun Apr 17 21:34:13 2022
...
directories = ['reference_genome_dir', 'target_genome_dir', 'prots_dir', 'nucls_dir', 'bbh_dir' ,'present_absence_dir','initial_models_dir', 'output_models_dir', 'gapfilled_models_dir', 'blast_exe_dir','temp_files','ref_model_dir','backupgenome']
...
def run_blastp(seq,db,in_folder='prots_dir', out_folder='bbh_dir', out=None,outfmt=6,evalue=0.001,threads=8):
    import os
    if out==None:
...
def run_blastn(seq, db,outfmt=6,evalue=0.001,threads=8):
    import os
